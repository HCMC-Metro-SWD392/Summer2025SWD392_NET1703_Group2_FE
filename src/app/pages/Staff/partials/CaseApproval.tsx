...
const CaseApproval: React.FC = () => {
  ...
  const columns = [
    {
      title: 'STT',
      key: 'index',
      render: (: any, _: any, index: number) => index + 1,
      width: 60,
  ...
  const stats = {
    ...
    pending: getSorted(0).length,
    approved: getSorted(1).length,
    rejected: getSorted(2).length
  };
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <Row gutter={16} className="mb-6">
        <Col span={6}><Card><Statistic title="Tổng số" value={stats.total} /></Card></Col>
        <Col span={6}><Card><Statistic title="Chờ duyệt" value={stats.pending} prefix={<ClockCircleOutlined />} /></Card></Col>
        <Col span={6}><Card><Statistic title="Đã duyệt" value={stats.approved} prefix={<CheckCircleOutlined />} /></Card></Col>
        <Col span={6}><Card><Statistic title="Bị từ chối" value={stats.rejected} prefix={<CloseCircleOutlined />} /></Card></Col>
      </Row>
